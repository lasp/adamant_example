--------------------------------------------------------------------------------
-- Cpp_Demo Component Tester Spec
--------------------------------------------------------------------------------

-- Includes:
with Component.Cpp_Demo_Reciprocal;
...
-- Adamant component.
package Component.Cpp_Demo.Implementation.Tester is

   use Component.Cpp_Demo_Reciprocal;
   ...
   type Instance is new Component.Cpp_Demo_Reciprocal.Base_Instance with record
      -- The component instance under test:
      Component_Instance : aliased Component.Cpp_Demo.Implementation.Instance;
      -- Connector histories:
