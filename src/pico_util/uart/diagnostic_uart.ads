...
-- own implementation of diagnostic_uard.adb and remove the default implementation
-- from the build path via:
--
-- $ export REMOVE_BUILD_PATH=~/adamant/src/components/ccsds_serial_interface/uart/default
--
